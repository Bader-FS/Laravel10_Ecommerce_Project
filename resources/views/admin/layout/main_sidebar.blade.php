<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('dashboard')}}" class="brand-link">
      <img src="{{asset('assets/dist/img/eco_icon.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Badr-Shop</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('assets/dist/img/badr-fs.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Badr Amrani</a>
        </div>
      </div>
